...
\frame{
	...
	{\LARGE{Another Problem:} \large{parameter estimates may be \textbf{biased} by a \textbf{study's duration}. 
	}}
}
...
\frame{
	...
	{\LARGE{A Similar Problem:}} {\large{\textbf{historical time-period bias}. \\
	\vspace{1cm}
...
\frame{
	...
	\end{center}
	Often difficult with current computational tools.
	}}
}
