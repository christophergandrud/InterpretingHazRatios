%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Interpreting Hazard Ratios in Political Science (short version)
% Christopher Gandrud
% 30 April 2013
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{equation}
%
Where $f(x)$ is the penalized spline function. For our post-estimation purposes $f(x)$ is basically a series of regression coefficients such that:
%
\begin{equation}
