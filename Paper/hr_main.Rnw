...
\usepackage{todonotes}
    ...
    \author{Christopher Gandrud\thanks{Lecturer in International Relations (\href{mailto:gandrud@yonsei.ac.kr}{gandrud@.ac.kr}) Note: I wrote the paper with Sweave \citep{Leisch2002}. The paper, including all empirical analyses and graphs can be reproduced with the Sweave document. Please contact me for the original.
...
\bibliography{/Users/christophergandrud/Dropbox/Ireland_Korea_Research/PhD_Thesis-1}
