...
The examples we have looked at so far study phenomenon using generic time.\footnote{Nonetheless, they may still be susceptible to time-period specific biases, though these would be difficult to detect without expanding the sampling time frame.}
